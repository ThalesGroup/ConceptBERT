...
class GloveConverter:
    ...
    def __init__(self):
        ...
        if not os.path.exists(
            "/home/mziaeefard/nas/human-ai-dialog/vilbert/data2/conceptnet/processed/glove.gensim"
        ):
            print(
                colored(
            ...
            if not os.path.exists(
                "/home/mziaeefard/nas/human-ai-dialog/vilbert/data2/conceptnet/raw/glove.840B.300d.txt"
            ):
                download_file(
            ...
            _ = glove2word2vec(
                "/home/mziaeefard/nas/human-ai-dialog/vilbert/data2/conceptnet/raw/glove.840B.300d.txt",
                "/home/mziaeefard/nas/human-ai-dialog/vilbert/data2/conceptnet/raw/glove_word2vec.txt",
            )
...
class NumberbatchConverter:
    ...
    def __init__(self):
        ...
        """
        if not os.path.exists(
            "/home/mziaeefard/nas/human-ai-dialog/vilbert/data2/conceptnet/processed/numberbatch_en.gensim"
        ):
            print(
                colored(
            ...
            # Downloads the model if needed
            if not os.path.exists(
                "/home/mziaeefard/nas/human-ai-dialog/vilbert/data2/conceptnet/raw/numberbatch_en.txt"
            ):
                download_file(
