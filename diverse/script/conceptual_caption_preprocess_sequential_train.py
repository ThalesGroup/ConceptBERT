...
class Conceptual_Caption(RNGDataFlow):
    ...
    def __init__(self, corpus_path, shuffle=False):
        ...
        self.name = os.path.join(
            corpus_path,
            "conceptual_caption_trainsubset_resnet101_faster_rcnn_genome.tsv.%d",
        )
        ...
        self.captions = {}
        # df = open_tsv(
        #     "/srv/share/datasets/conceptual_caption/DownloadConceptualCaptions/Train_GCC-training.tsv",
        #     "training",
        # )
        df = open_tsv(
            "/nas-data/vilbert/data2/conceptual_captions/Train_GCC-training.tsv",
            "training",
        )
