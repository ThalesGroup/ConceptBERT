...
# Custom libraries
from conceptBert.graph_refinement.utils import (
    extract_nodes,
...
class ConceptNet:
    ...
    def get_index(self, word):
        """
            Given a word, finds the corresponding index in ConceptNet
    ...
    def get_word(self, index):
        """
            Given an index (for ConceptNet), finds the corresponding word
        """
        try:
