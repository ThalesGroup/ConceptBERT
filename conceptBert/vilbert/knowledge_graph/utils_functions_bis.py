...
def download_file(source_url, dest_path, source_path=""):
    ...
    if file_extension == "zip":
        ...
        with open("/home/mziaeefard/nas/human-ai-dialog/vilbert/data2/conceptnet/raw/temp.zip", "wb") as f:
        ...
        z = zipfile.ZipFile("/home/mziaeefard/nas/human-ai-dialog/vilbert/data2/conceptnet/raw/temp.zip")
        ...
        os.remove("/home/mziaeefard/nas/human-ai-dialog/vilbert/data2/conceptnet/raw/temp.zip")

    elif file_extension == "gz":
        # Save the GZ file in a temporary GZ file
        with open(
            "/home/mziaeefard/nas/human-ai-dialog/vilbert/data2/conceptnet/raw/temp.gz", "wb"
        ) as temp_file:
            for data in r.iter_content(block_size):
                t.update(len(data))
        ...
        with gzip.open(
            "/home/mziaeefard/nas/human-ai-dialog/vilbert/data2/conceptnet/raw/temp.gz", "rb"
        ) as file_in:
            with open(dest_path, "wb") as file_out:
                shutil.copyfileobj(file_in, file_out)

        # Remove the temporary file
        os.remove("/home/mziaeefard/nas/human-ai-dialog/vilbert/data2/conceptnet/raw/temp.gz")
