...
from kilbert.graph_refinement.conceptnet_graph import ConceptNet

from vilbert.vilbert import VILBertForVLTasks
from q_kg_transformer.transformer import QuestionGraphTransformer
from kilbert.graph_refinement.graph_refinement import GraphRefinement

from kilbert.fusion_modules.question_fusion import (
    SimpleQuestionAddition,
    SimpleQuestionMultiplication,
    SimpleQuestionConcatenation,
)
from kilbert.fusion_modules.aggregator import SimpleConcatenation
from kilbert.fusion_modules.bertpooler import BertTextPooler, BertImagePooler
from kilbert.fusion_modules.cti_model.cti import CTIModel

from kilbert.classifier.classifier import SimpleClassifier
...
class QuestionPooler(nn.Module):
    ...
    def forward(self, hidden_states):
        ...
        pooled_output = self.dense2(pooled_output.transpose(2, 1))
