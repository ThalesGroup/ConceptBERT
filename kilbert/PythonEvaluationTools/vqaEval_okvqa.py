...
output_dir = '/nas-data/vilbert/outputs/JOB_NAME_PLACEHOLDER-JOB_ID_PLACEHOLDER/'
res_name = 'val_result'
...
[accuracyFile, evalQAFile, evalQuesTypeFile, evalAnsTypeFile] = ['%s/%s.json'%(output_dir, fileType) for fileType in fileTypes]
