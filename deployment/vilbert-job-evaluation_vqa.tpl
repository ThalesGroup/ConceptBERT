      ...
      - name: vilbert-pod
        ...
        resources:
          limits:
            nvidia.com/gpu: 1
        command: ["/bin/sh","-c"]
        args: ["ls && python kilbert/PythonEvaluationTools/vqaEval_okvqa.py --json_dir /nas-data/vilbert/outputs/vilbert-job-0.1.dev492-g62dfbf2.d20200924143315/ --output_dir /nas-data/vilbert/outputs/vilbert-job-0.1.dev492-g62dfbf2.d20200924143315"]
        volumeMounts:
          - name: nas-data-volume
            mountPath: /nas-data
          - name: dshm
