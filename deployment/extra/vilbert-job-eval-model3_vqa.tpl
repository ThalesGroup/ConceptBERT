      ...
      - name: vilbert-pod
        ...
        resources:
          limits:
            nvidia.com/gpu: 4
        command: ["/bin/sh","-c"]
        args: ["cd kilbert && python3 -u eval_tasks.py --model_version 3 --bert_model=bert-base-uncased --from_pretrained=/nas-data/vilbert/data2/save_final/VQA_bert_base_6layer_6conect-beta_vilbert_vqa/pytorch_model_11.bin --from_pretrained_kilbert /nas-data/vilbert/data2/save_final/VQA_model3-kilbert_FINAL/pytorch_model_19.bin --config_file config/bert_base_6layer_6conect.json --output_dir=/nas-data/vilbert/data2/save_final/OKVQA_model3-kilbert --num_workers 16 --tasks 0 --split val"]
        volumeMounts:
          - name: nas-data-volume
            mountPath: /nas-data
          - name: dshm
